...
function Page() {
	return (
		<div className="flex flex-col start justify-center gap-10 w-full">
			<Heading
				title="Kalendarz Roku Szkolnego 2024/2025"
				description=""
			/>
			<div>
			...
			<Table>
				...
				<TableRow>
					<TableCell>
						Wystawienie zagrożeń ocenami niedostatecznymi w klasach maturalnych
						i poinformowanie rodziców
					</TableCell>
				...
				<TableRow>
					<TableCell>
						Egzamin maturalny: - pisemny (od 7.05 do 24.05.2024 r.) - ustny (od
						21.05 do 24.05.2024 r.)
					</TableCell>
				...
				<TableRow>
					<TableCell>
						Wystawienie zagrożeń ocenami niedostatecznymi i nagannym zachowaniem
						oraz poinformowanie rodziców
					</TableCell>
				...
				<TableRow>
					<TableCell>
						Wystawienie propozycji ocen z wszystkich przedmiotów i zachowania na
						koniec roku
					</TableCell>
